...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/403.css">
...
<!-- The content outside of SVG -->
<h1>You are not allowed to enter here</h1>
<h2>Go <a href="javascript:history.go(-1);">Home!</a></h2>
