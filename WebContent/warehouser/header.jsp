...
<div class="sidebar">
<div class="logo">
	<a class="d-flex align-items-center" href="${pageContext.request.contextPath}/warehouser/" ><img src="../images/Logo.png" height="40" width = "40" alt="Store Logo" />Keyboard Store</a>
</div>
